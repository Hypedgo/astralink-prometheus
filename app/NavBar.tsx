...
export default function NavBar() {
    ...
    return (
        <div style={{
            ...
            <Link href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', width: '600px', flexShrink: 0 }}>
                <Image
                    src="/logo.png"
                    alt="AstraLink"
                    width={600}
                    height={170}
                    style={{ objectFit: 'contain', objectPosition: 'left center', width: '600px', height: '170px' }}
                />
            </Link>
