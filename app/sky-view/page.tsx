...
// Space Weather Component (NOAA API)
function SpaceWeather() {
    ...
    return (
        <div style={{
            ...
            <div style={{ fontSize: '12px', color: '#22d3ee', marginBottom: '12px', letterSpacing: '2px', fontWeight: '600' }}>
                SPACE WEATHER
            </div>
...
// Earth Weather Component (Open-Meteo API)
...
function MissionReadiness({ latitude, longitude }: { latitude: number; longitude: number }) {
    ...
    useEffect(() => {
        ...
        calculateReadiness()
        const interval = setInterval(calculateReadiness, 60000)
        return () => clearInterval(interval)
    }, [latitude, longitude])
...
function SystemStatus() {
    return (
        <div style={{
            ...
            <div style={{ fontSize: '10px', color: '#22d3ee', marginBottom: '10px', letterSpacing: '2px', fontWeight: '600' }}>
                SYSTEM STATUS
            </div>
...
function MissionBrief({ location }: { location: { displayName: string } }) {
    return (
        <div style={{
            position: 'fixed',
            top: '30px',
            ...
            <div style={{ fontSize: '12px', color: '#22d3ee', marginBottom: '8px', letterSpacing: '2px', fontWeight: '600' }}>
                MISSION LOCATION
            </div>
            ...
            <div style={{ fontSize: '11px', color: '#888', marginTop: '8px' }}>
                Active Tracking: ISS, Satellites
            </div>
        </div>
    )
}
